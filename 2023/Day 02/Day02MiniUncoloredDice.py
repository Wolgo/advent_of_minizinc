...
# Setup Minizinc
model = Model("Day02MiniUncoloredDice.mzn")
...
print(result)
print("blue: " + str(result["blue_dice"]))
print("red: " + str(result["red_dice"]))
print("green: " + str(result["green_dice"]))
print("Total games possible: " + str(result["result"]))
